...
<qgis version="2.12.3-Lyon" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="0" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 attr="kategori" forceraster="0" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="Cykelväg, parkväg" label="Cykelväg, parkväg"/>
      <category render="true" symbol="1" value="Elljusspår" label="Elljusspår"/>
      <category render="true" symbol="2" value="Farled" label="Farled"/>
      <category render="true" symbol="3" value="Gångbro och spång" label="Gångbro och spång"/>
      <category render="true" symbol="4" value="Gångstig" label="Gångstig"/>
      <category render="true" symbol="5" value="Linbana" label="Linbana"/>
      <category render="true" symbol="6" value="Traktorväg" label="Traktorväg"/>
      <category render="true" symbol="7" value="Underfart för övrig väg eller led" label="Underfart för övrig väg eller led"/>
      <category render="true" symbol="8" value="Vandringsled" label="Vandringsled"/>
      <category render="true" symbol="9" value="Vandringsled, längs väg" label="Vandringsled, längs väg"/>
    ...
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="1">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="255,242,47,255"/>
          <prop k="line_style" v="solid"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="8">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="229,143,175,255"/>
          <prop k="line_style" v="solid"/>
    ...
    <source-symbol>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="19,221,171,255"/>
          <prop k="line_style" v="solid"/>
