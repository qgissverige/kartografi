...
<qgis version="2.12.3-Lyon" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="0" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="kategori" forceraster="0" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="Rastplats" label="Rastplats"/>
      <category render="true" symbol="1" value="Tunnelöppning för väg" label="Tunnelöppning för väg"/>
      <category render="true" symbol="2" value="Vägbom" label="Vägbom"/>
      <category render="true" symbol="3" value="Vändplan" label="Vändplan"/>
      <category render="false" symbol="4" value="Öppningsbar bro" label="Öppningsbar bro"/>
    </categories>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="marker" name="0">
        <layer pass="0" class="SvgMarker" locked="0">
          ...
          <prop k="name" v="gpsicons/table.svg"/>
          <prop k="offset" v="0,0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" name="1">
        <layer pass="0" class="FontMarker" locked="0">
          ...
          <prop k="angle_dd_expression" v="180-&quot;srikt&quot;"/>
          ...
          <prop k="font" v="Arial"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="offset" v="5.55112e-17,-17"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
