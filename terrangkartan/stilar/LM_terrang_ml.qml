...
<qgis version="2.12.2-Lyon" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="0" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{28422f00-9fb7-40fb-aeea-52010ca5a631}">
      <rule filter="strpos(&quot;kategori&quot;, 'V.yta dif. Str')>0 OR left(&quot;kategori&quot;,10)='Skog - Vat'" key="{28291430-0c4d-47be-867a-6d79783735f1}" symbol="0" label="Diffus Strandlinje"/>
      <rule filter="left(&quot;kategori&quot;,6)='Vatten' AND substr(&quot;kategori&quot;,11,3)&lt;>'- V'" key="{5073df70-e520-4e01-8609-7ee6e86ad407}" symbol="1" label="Vattenlinje"/>
    </rules>
    <symbols>
