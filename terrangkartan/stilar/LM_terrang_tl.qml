...
<qgis version="2.12.3-Lyon" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="0" scaleBasedLabelVisibilityFlag="0">
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="46,152,255,255"/>
  ...
  <labeling type="rule-based">
    <rules>
      <rule description="Vattendrag" filter=" left(&quot;kategori&quot;,10)='Vattendrag'">
        <settings>
          <text-style fontItalic="1" fontFamily="Arial" fontLetterSpacing="0" fontUnderline="0" fontSizeMapUnitMaxScale="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="46,152,255,255" fontSizeMapUnitMinScale="0" fontSizeInMapUnits="1" isExpression="0" blendMode="0" fontSize="100" fieldName="text" namedStyle="Italic" fontWordSpacing="0"/>
          ...
          <placement repeatDistanceUnit="1" placement="3" maxCurvedCharAngleIn="40" repeatDistance="0" distMapUnitMaxScale="0" labelOffsetMapUnitMaxScale="0" distInMapUnits="0" labelOffsetInMapUnits="1" xOffset="0" preserveRotation="1" centroidWhole="0" priority="10" repeatDistanceMapUnitMaxScale="0" yOffset="0" placementFlags="9" repeatDistanceMapUnitMinScale="0" centroidInside="0" dist="0" angleOffset="0" maxCurvedCharAngleOut="-40" fitInPolygonOnly="0" quadOffset="4" distMapUnitMinScale="0" labelOffsetMapUnitMinScale="0"/>
          <rendering fontMinPixelSize="3" scaleMax="10000000" fontMaxPixelSize="10000" scaleMin="1" upsidedownLabels="2" limitNumLabels="0" obstacle="1" obstacleFactor="1" scaleVisibility="0" fontLimitPixelSize="0" mergeLines="0" obstacleType="0" labelPerPart="0" maxNumLabels="2000" displayAll="1" minFeatureSize="0"/>
          <data-defined>
            <Size expr="to_int(right(&quot;Kategori&quot;,1))*15+85" field="" active="true" useExpr="true"/>
          </data-defined>
        </settings>
      </rule>
    </rules>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value=" left(&quot;kategori&quot;,10)='Vattendrag'"/>
