...
<qgis simplifyDrawingHints="1" simplifyDrawingTol="1" version="3.8.1-Zanzibar" simplifyMaxScale="1" readOnly="0" minScale="1e+8" simplifyLocal="1" maxScale="-4.65661e-10" styleCategories="AllStyleCategories" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="0">
  ...
  <renderer-v2 enableorderby="0" type="RuleRenderer" symbollevels="0" forceraster="0">
    <rules key="{749a4a17-6b9d-4349-8b48-809df8303e7e}">
      <rule filter="&quot;KKOD&quot; IN (2530)" label="Telefonledning" key="{77ab7902-4ebc-488f-a4e0-b1731dd2d42d}" symbol="0"/>
      <rule filter="&quot;KKOD&quot; IN (2611, 2618)" label="Kraftledning stam" key="{22a60d1c-15c8-4e10-acfd-a9963604f5be}" symbol="1"/>
      <rule filter="&quot;KKOD&quot; IN (2612)" label="Kraftledning region" key="{22a60d1c-15c8-4e10-acfd-a9963604f5be}" symbol="2"/>
      <rule filter="&quot;KKOD&quot; IN (2614)" label="Kraftledning fördelning" key="{22a60d1c-15c8-4e10-acfd-a9963604f5be}" symbol="3"/>
    </rules>
    <symbols>
