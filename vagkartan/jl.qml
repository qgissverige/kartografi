...
<qgis simplifyDrawingHints="1" simplifyDrawingTol="1" version="3.8.1-Zanzibar" simplifyMaxScale="1" readOnly="0" minScale="1e+8" simplifyLocal="1" maxScale="-4.65661e-10" styleCategories="AllStyleCategories" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="0">
  <flags>
  ...
  <renderer-v2 enableorderby="0" type="RuleRenderer" symbollevels="0" forceraster="0">
    <rules key="{b527f272-eb1b-4ccf-9173-1c173d74adf6}">
      <rule filter="&quot;KKOD&quot; IN (271, 272)" label="Järnväg enkelspar" key="{0e17dc50-025c-4f44-ab2a-00b5cef569e5}" symbol="0"/>
      <rule filter="&quot;KKOD&quot; IN (270)" label="Järnväg byg" key="{a6a60db7-af19-42c7-9651-20188469c618}" symbol="1"/>
      <rule filter="&quot;KKOD&quot; IN (273)" label="Järnväg dubbelspar" key="{bcc4c985-a3b4-48b8-a462-ecdac4cd84b5}" symbol="2"/>
      <rule filter="&quot;KKOD&quot; IN (274, 275, 276)" label="Järnväg smalspar" key="{6425d9a0-9131-4206-99a2-c2b20669ba8e}" symbol="3"/>
      <rule filter="&quot;KKOD&quot; IN (279)" label="Industrispar" key="{3ba63775-a3c5-482a-80d3-3367519f4f6e}" symbol="4"/>
      <rule filter="&quot;KKOD&quot; IN (291, 292, 293, 294, 295, 296, 299)" label="Jv i underfart" key="{eeb365de-d184-4868-8668-f1d3bb884912}" symbol="5"/>
    </rules>
    <symbols>
