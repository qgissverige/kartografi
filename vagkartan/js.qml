...
<qgis simplifyDrawingHints="0" simplifyDrawingTol="1" version="3.8.1-Zanzibar" simplifyMaxScale="1" readOnly="0" minScale="1e+8" simplifyLocal="1" maxScale="-4.65661e-10" styleCategories="AllStyleCategories" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="0">
  ...
  <renderer-v2 enableorderby="0" type="RuleRenderer" symbollevels="0" forceraster="0">
    <rules key="{a8e2f1cc-1268-429e-a478-f380c1f5f603}">
      <rule filter="&quot;KKOD&quot; IN (351)" label="Station" key="{6099ae53-6458-48ef-a806-137cad2b58a3}" symbol="0"/>
      <rule filter="&quot;KKOD&quot; IN (355)" label="Tunnel" key="{ef00a496-0c2a-4d78-8f6c-d4d79aa87a6a}" symbol="1"/>
    </rules>
    <symbols>
      <symbol name="0" type="marker" clip_to_extent="1" force_rhr="0" alpha="1">
        <layer class="SvgMarker" enabled="1" pass="0" locked="0">
          ...
          <prop v="jvg_station1.svg" k="name"/>
          <prop v="0,0" k="offset"/>
