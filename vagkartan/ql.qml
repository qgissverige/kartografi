...
<qgis simplifyDrawingHints="1" simplifyDrawingTol="1" version="3.8.1-Zanzibar" simplifyMaxScale="1" readOnly="0" minScale="1e+8" simplifyLocal="1" maxScale="0" styleCategories="AllStyleCategories" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="0">
  ...
  <renderer-v2 enableorderby="0" type="RuleRenderer" symbollevels="0" forceraster="0">
    <rules key="{a50dc7b2-0eab-4fdc-a2d9-a6815acb49fd}">
      <rule filter="&quot;KKOD&quot; IN (16)" label="Skyddsomrade" key="{f8dcbf8e-6f6a-41a3-961a-1b859ae95b44}" symbol="0"/>
      <rule filter="&quot;KKOD&quot; IN (17, 59)" label="Skjutfält omrade" key="{b14ee3a4-b555-44ce-9839-47d2e0709d55}" symbol="1"/>
      <rule filter="&quot;KKOD&quot; IN (17)" label="Skjutfält omrade" key="{f8dcbf8e-6f6a-41a3-961a-1b859ae95b44}" symbol="2"/>
      <rule filter="&quot;KKOD&quot; IN (58)" label="Övningsomrade maG" key="{f8dcbf8e-6f6a-41a3-961a-1b859ae95b44}" symbol="3"/>
      <rule filter="&quot;KKOD&quot; IN (96)" label="Övningsomrade" key="{181d352e-1fa6-4e81-b314-dd95c74c46ff}" symbol="4"/>
    </rules>
    <symbols>
      <symbol name="0" type="line" clip_to_extent="1" force_rhr="0" alpha="0.803922">
      ...
      <symbol name="1" type="line" clip_to_extent="1" force_rhr="0" alpha="0.670588">
        <layer class="SimpleLine" enabled="1" pass="0" locked="0">
