...
<qgis simplifyDrawingHints="1" simplifyDrawingTol="1" version="3.8.1-Zanzibar" simplifyMaxScale="1" readOnly="0" minScale="1e+8" simplifyLocal="1" maxScale="0" styleCategories="AllStyleCategories" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="0">
  ...
  <renderer-v2 enableorderby="0" type="RuleRenderer" symbollevels="0" forceraster="0">
    <rules key="{386cde1e-35cd-4a67-b38d-0ae4ff1d16f4}">
      <rule filter="&quot;KKOD&quot; IN (21)" label="Riksgräns" key="{68d7a538-c63d-422e-8370-504ee88d578c}" symbol="0"/>
      <rule filter="&quot;KKOD&quot; IN (22)" label="Territorialgräns" key="{dcfeac60-6454-4892-ae41-76fb7293feca}" symbol="1"/>
      <rule filter="&quot;KKOD&quot; IN (23)" label="Länsgräns" key="{ff4904eb-5fc5-4d8c-9b5d-fead6f0f73a8}" symbol="2"/>
      <rule filter="&quot;KKOD&quot; IN (24)" label="Kommungräns" key="{dcfeac60-6454-4892-ae41-76fb7293feca}" symbol="3"/>
      <rule filter="&quot;KKOD&quot; IN (33)" label="Traktgräns" key="{dcfeac60-6454-4892-ae41-76fb7293feca}" symbol="4"/>
      <rule checkstate="0" filter="&quot;KKOD&quot; IN (480)" label="Odlingsgräns med annan" key="{dcfeac60-6454-4892-ae41-76fb7293feca}" symbol="5"/>
      <rule filter="&quot;KKOD&quot; IN (481)" label="Odlingsgräns" key="{dcfeac60-6454-4892-ae41-76fb7293feca}" symbol="6"/>
    </rules>
    <symbols>
