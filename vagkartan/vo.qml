...
<qgis simplifyDrawingHints="1" simplifyDrawingTol="1" version="3.8.1-Zanzibar" simplifyMaxScale="1" readOnly="0" minScale="1e+8" simplifyLocal="1" maxScale="-4.65661e-10" styleCategories="AllStyleCategories" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="0">
  ...
  <renderer-v2 enableorderby="0" type="RuleRenderer" symbollevels="0" forceraster="0">
    <rules key="{c6ca84b2-7520-42b5-929f-1155607c480e}">
      <rule filter="&quot;KKOD&quot; IN (254)" label="Cykelled" key="{654542bd-5418-40a3-88ee-7d831e6eb963}" symbol="0"/>
      <rule filter="&quot;KKOD&quot; IN (264)" label="Gangstig" key="{654542bd-5418-40a3-88ee-7d831e6eb963}" symbol="1"/>
      <rule filter="&quot;KKOD&quot; IN (265)" label="Vandringsled" key="{654542bd-5418-40a3-88ee-7d831e6eb963}" symbol="2"/>
      <rule filter="&quot;KKOD&quot; IN (268)" label="Vandringsled längs väg" key="{654542bd-5418-40a3-88ee-7d831e6eb963}" symbol="3"/>
      <rule filter="&quot;KKOD&quot; IN (289)" label="Annan led" key="{654542bd-5418-40a3-88ee-7d831e6eb963}" symbol="4"/>
      <rule checkstate="0" filter="&quot;KKOD&quot; IN (332)" label="Gangbro" key="{654542bd-5418-40a3-88ee-7d831e6eb963}" symbol="5"/>
      <rule filter="&quot;KKOD&quot; IN (335)" label="Farled" key="{654542bd-5418-40a3-88ee-7d831e6eb963}" symbol="6"/>
      <rule filter="&quot;KKOD&quot; IN (336)" label="Färjeled" key="{382b8b3c-0a20-410b-8b7c-d09c56a706d0}" symbol="7"/>
    </rules>
    <symbols>
