...
<qgis simplifyDrawingHints="1" simplifyDrawingTol="1" version="3.8.1-Zanzibar" simplifyMaxScale="1" readOnly="0" minScale="1e+8" simplifyLocal="1" maxScale="-4.65661e-10" styleCategories="AllStyleCategories" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="0">
  ...
  <renderer-v2 enableorderby="0" type="RuleRenderer" symbollevels="0" forceraster="0">
    <rules key="{2dcc843d-95c3-4064-abba-9e41a5323059}">
      <rule filter="&quot;KKOD&quot; IN (441)" label="Storlek 1" key="{1eebeef4-5152-4e59-95df-199b652277bb}" symbol="0"/>
      <rule filter="&quot;KKOD&quot; IN (455)" label="Storlek 2" key="{1eebeef4-5152-4e59-95df-199b652277bb}" symbol="1"/>
      <rule filter="&quot;KKOD&quot; IN (456)" label="Storlek 3" key="{1eebeef4-5152-4e59-95df-199b652277bb}" symbol="2"/>
      <rule filter="&quot;KKOD&quot; IN (458)" label="under mark" key="{b2d9961d-e3c0-41fe-9bf3-435c614e0bee}" symbol="3"/>
    </rules>
    <symbols>
      <symbol name="0" type="line" clip_to_extent="1" force_rhr="0" alpha="1">
        <layer class="SimpleLine" enabled="1" pass="0" locked="0">
          ...
          <prop v="0,139,197,255" k="line_color"/>
