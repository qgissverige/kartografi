...
<qgis simplifyDrawingHints="0" simplifyDrawingTol="1" version="3.8.1-Zanzibar" simplifyMaxScale="1" readOnly="0" minScale="1e+8" simplifyLocal="1" maxScale="0" styleCategories="AllStyleCategories" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="0">
  ...
  <renderer-v2 enableorderby="0" type="RuleRenderer" symbollevels="0" forceraster="0">
    <rules key="{ef92e379-5fe6-4041-83c6-9eced8fa4469}">
      <rule filter="&quot;KKOD&quot; IN (746)" label="Ruin" key="{8160fe43-7e9e-40ed-949e-5fe58c6c21bd}" symbol="0"/>
      <rule filter="&quot;KKOD&quot; IN (751)" label="Gruvhal" key="{8b3aa3b5-27cc-4fa7-af55-fdce3006082a}" symbol="1"/>
      <rule filter="&quot;KKOD&quot; IN (773)" label="Fornlämning" key="{91e4ab7c-5073-4b42-8796-792658dda5c8}" symbol="2"/>
    </rules>
    <symbols>
