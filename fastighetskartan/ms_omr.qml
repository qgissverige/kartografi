...
<qgis version="2.8.1-Wien" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="DETALJTYP" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="SANK" label="SANK"/>
      <category render="true" symbol="1" value="SANKSVÅ" label="SANKSVÅ"/>
      <category render="true" symbol="2" value="SANKBLE" label="SANKBLE"/>
    ...
    <symbols>
        ...
        <layer pass="0" class="LinePatternFill" locked="0">
          ...
          <symbol alpha="1" type="line" name="@0@0">
            <layer pass="0" class="SimpleLine" locked="0">
              ...
              <prop k="line_color" v="174,46,0,255"/>
      ...
      <symbol alpha="1" type="fill" name="2">
        <layer pass="0" class="LinePatternFill" locked="0">
          ...
          <symbol alpha="1" type="line" name="@2@0">
            <layer pass="0" class="SimpleLine" locked="0">
              <prop k="capstyle" v="square"/>
              <prop k="customdash" v="2;1;2;1"/>
              <prop k="customdash_map_unit_scale" v="0,0"/>
              <prop k="customdash_unit" v="MM"/>
              <prop k="draw_inside_polygon" v="0"/>
              <prop k="joinstyle" v="bevel"/>
              <prop k="line_color" v="57,34,205,255"/>
      ...
      <symbol alpha="1" type="fill" name="3">
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="color" v="246,229,160,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
