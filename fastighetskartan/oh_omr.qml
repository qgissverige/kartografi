...
<qgis version="2.6.0-Brighton" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="DETALJTYP" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="GROP5.K" label="GROP5.K"/>
      <category render="true" symbol="1" value="HÖJDK25" label="HÖJDK25"/>
      <category render="true" symbol="2" value="HÖJDK5" label="HÖJDK5"/>
    ...
    <symbols>
      <symbol alpha="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="249,176,41,255"/>
        ...
        <layer pass="0" class="MarkerLine" locked="0">
          ...
          <symbol alpha="1" type="marker" name="@0@1">
            <layer pass="0" class="SimpleMarker" locked="0">
              <prop k="angle" v="0"/>
              <prop k="color" v="249,176,41,255"/>
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="name" v="line"/>
              <prop k="offset" v="0,0"/>
              <prop k="offset_map_unit_scale" v="0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="249,176,41,255"/>
      ...
      <symbol alpha="1" type="line" name="3">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="228,36,231,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.1"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="DETALJTYP"/>
