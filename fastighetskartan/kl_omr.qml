...
<qgis version="2.8.1-Wien" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="DETALJTYP" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="KRAFTFÖ.M" label="KRAFTFÖ.M"/>
      <category render="true" symbol="1" value="KRAFTST.M" label="KRAFTST.M"/>
      <category render="true" symbol="2" value="TRAFOMR.B" label="TRAFOMR.B"/>
      <category render="true" symbol="3" value="KRAFTRE.M" label="KRAFTRE.M"/>
      <category render="true" symbol="4" value="RÖRLEDN.M" label="RÖRLEDN.M"/>
